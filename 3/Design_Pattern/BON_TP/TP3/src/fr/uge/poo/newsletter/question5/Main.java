...
public class Main {
  ...
  static void main() {
    ...
    var univNewsletter = Newsletter.with()
            .name("Java 4ever")
            .subscribe(univUsers)
            .observer(new MailObeserver(new GMailAdapter()))
            .condition(u -> u.email().endsWith("@univ-eiffel.fr") && u.age() % 2 == 0)
            .mailSystem(new EEMailAdapter())
            .build();

//    univNewsletter.sendMessage("Test mail", "Bla Bla");
//    javaNewsletter.sendMessage("Test mail", "Bla Bla");
  }
