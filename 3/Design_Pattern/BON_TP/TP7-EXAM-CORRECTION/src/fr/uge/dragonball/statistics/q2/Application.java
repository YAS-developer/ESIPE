...
public class Application {
  ...
  static void main(String[] args) {
    ...
    var superBlue = new Transformation("Super Blue", fighter -> fighter.power() * fighter.maxHealth(), fighter -> 1);

    var transform = goku.transformation(superSayen);
    var transform2 = fusion1.transformation(superBlue);
    var transform3 = megaFusion.transformation(superSayen2);
