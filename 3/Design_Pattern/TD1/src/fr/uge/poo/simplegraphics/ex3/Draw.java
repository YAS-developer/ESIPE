...
public final class Draw {
	...
	record Rectangle (int x1, int y1, int width, int heigth) implements Shape{}
	
	record Elipse (int x1, int y1, int width, int heigth) implements Shape{}
	
	private final static ArrayList<Shape> lineList = new ArrayList<Shape>();
