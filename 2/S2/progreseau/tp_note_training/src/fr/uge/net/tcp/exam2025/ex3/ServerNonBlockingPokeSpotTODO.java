...
public class ServerNonBlockingPokeSpotTODO {
	...
	static private Logger logger = Logger.getLogger(ServerNonBlockingPokeSpotTODO.class.getName());

	private final ServerSocketChannel serverSocketChannel;
	private final Selector selector;

	public ServerNonBlockingPokeSpotTODO(int port) throws IOException {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		new ServerNonBlockingPokeSpotTODO(Integer.parseInt(args[0])).launch();
	}
