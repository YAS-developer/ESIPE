...
Production soumise à la relecture : **sudoku**
Projet/code produit par **Romain BUGES**
Relecture opérée par **Yassine HAMROUNI** le 25 janvier 2024
...
Mettre un pop up ou un texte qui permet d'avertir le joueur de que le chiffre à mettre ne peut pas être mis dans la case.
...
Les algorithmes sont tres bien optimises.
...
Lorsqu'on mets un chiffre dans la case ou bien qu'on l'efface "délocker" la case et enlever le pavé numérique. Mais bon en vrai c'est très bien comme ca :).
