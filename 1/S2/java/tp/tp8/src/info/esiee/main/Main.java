...
//    System.out.println(Actor.actorGroupByFirstName(actors));
    ...
    new Actor("bob", "de niro"),
    new Actor("willy", "cat"),
    new Actor("bob", "cat")
	);

	// Grouper par prénom
	var groupByFirstName = Actor.actorGroupByFirstName(actors);
	System.out.println("Group by First Name: " + groupByFirstName);
	
	// Grouper par prénom en utilisant la méthode générique
	var groupByFirstNameGeneric = Actor.actorGroupBy(actors, Actor::firstName);
	System.out.println("Group by First Name (Generic): " + groupByFirstNameGeneric);
	
	// Grouper par nom de famille
	var groupByLastName = Actor.actorGroupBy(actors, Actor::lastName);
	System.out.println("Group by Last Name: " + groupByLastName);
